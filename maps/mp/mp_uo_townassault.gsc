...
fixBugs() {
	...
	level thread blockBox((-4423,4524,100), (35,5,80));	
	level thread blockBox((-4470,4550,100), (35,5,80));	
	level thread blockBox((-4525,4580,100), (35,10,80));
	level thread blockBox((-4575,4620,100), (35,10,80));
	level thread blockBox((-4610,4662,100), (25,15,80));	
	level thread blockBox((-4655,4715,100), (35,15,80));	

	level thread blockBox((-274,7607, 200), (3,15,20));
	level thread blockbox((-4970, 12730, 340), (2,150,18));
}
